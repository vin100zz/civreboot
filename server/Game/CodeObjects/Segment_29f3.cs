...
namespace OpenCivOne
{
	public class Segment_29f3
	{
		...
		public Segment_29f3(OpenCivOneGame parent)
		{
			this.oParent = parent;
		...
		/// <returns></returns>
		public ushort F0_29f3_000e(int playerID1, int unitID1, int playerID2, int unitID2, bool flag)
		{
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)unitID1);
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8),
				(short)this.oParent.GameData.Players[playerID1].Units[unitID1].UnitType);

			this.oCPU.AX.UInt16 = 0x600;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)playerID2);
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = 0xc;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)unitID2);
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe),
				(short)this.oParent.GameData.Players[playerID2].Units[unitID2].UnitType);
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].AttackStrength);
			...
			this.oCPU.TEST_UInt8(this.oCPU.AX.LowUInt8, 0x20);
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20)));
			this.oCPU.DI.UInt16 = this.oCPU.AX.UInt16;

			this.oCPU.AX.LowUInt8 = (byte)this.oParent.GameData.Terrains[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))].DefenseBonus;
			this.oCPU.CBW(this.oCPU.AX);

			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, 
				(ushort)((short)this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].DefenseStrength));
			this.oCPU.CX.LowUInt8 = 0x3;
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
		...
		L00ac:
			...
			if ((this.oParent.GameData.Players[playerID2].Units[unitID2].Status & 0x8) == 0)
				goto L00e8;
		...
		L013c:
			...
			if (this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].MovementType == UnitMovementTypeEnum.Air)
				goto L0152;

			if (this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].MovementType != UnitMovementTypeEnum.Water)
				goto L0165;
		...
		L0152:
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].DefenseStrength);
			this.oCPU.CX.LowUInt8 = 0x3;
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a), this.oCPU.AX.UInt16);
		...
		L0195:
			...
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TEST_UInt16(this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].ImprovementFlags0, 0x80);
			...
			if (this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].AttackStrength == 12)
				goto L01f2;
		...
		L01f2:
			...
			if (this.oParent.GameData.Players[playerID2].CityCount == 1)
			{
		...
		L0224:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e), 0x1);
		...
		L0229:
			...
			if ((this.oParent.GameData.Players[playerID1].Units[unitID1].Status & 0x20) != 0)
			{
				this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10));
				this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
				this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
				...
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 
					this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), this.oCPU.AX.UInt16));
			}
			...
			if ((this.oParent.GameData.Players[playerID2].Units[unitID2].Status & 0x20) != 0)
			{
				...
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a), 
					this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a)), this.oCPU.AX.UInt16));
			}
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26), this.oParent.GameData.Players[playerID1].Units[unitID1].RemainingMoves);

			if (this.oParent.GameData.Players[playerID1].Units[unitID1].RemainingMoves < 3)
			{
				this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10),
					(short)((this.oParent.GameData.Players[playerID1].Units[unitID1].RemainingMoves * this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))) / 3));
			}
		...
		L02ac:
			...
			if (this.oParent.GameData.DifficultyLevel > 1) goto L02cd;
			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.HumanPlayerID;
			this.oCPU.CMP_UInt16((ushort)playerID2, this.oCPU.AX.UInt16);
		...
		L02cd:
			if (this.oParent.GameData.DifficultyLevel != 0) goto L02df;
			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.HumanPlayerID;
			this.oCPU.CMP_UInt16((ushort)playerID1, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE) goto L02df;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.SHL_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x1));
		...
		L02df:
			...
			this.oParent.GameData.Players[playerID1].Units[unitID1].GoToDestination.X = -1;
		...
		L030f:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.CAPI.RNG.Next(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a))));

			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;

			// Instruction address 0x29f3:0x0324, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.CAPI.RNG.Next(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))));

			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, this.oCPU.SI.UInt16);
			if (this.oCPU.Flags.LE) goto L0335;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x24), 0x10);

		L0335:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e)), 0x0);
		...
		L0362:
			...
			this.oCPU.AX.UInt16 = this.oParent.GameData.Players[playerID1].Units[unitID1].VisibleByPlayer;
			...
			this.oCPU.AX.UInt16 = this.oParent.GameData.Players[playerID2].Units[unitID2].VisibleByPlayer;
			
			this.oCPU.TEST_UInt16(this.oCPU.AX.UInt16, this.oCPU.SI.UInt16);
			if (this.oCPU.Flags.NE) goto L03b4;
			
			if (this.oParent.Var_d806_DebugFlag) goto L03b4;
			goto L0721;
		...
		L03b4:
			...
			if (this.oParent.MapManagement.F0_2aea_03ba_DrawCell(this.oParent.GameData.Players[playerID1].Units[unitID1].Position.X, 
				this.oParent.GameData.Players[playerID1].Units[unitID1].Position.Y)) goto L0416;
			goto L0721;
		...
		L0416:
			...
			if (this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].AttackStrength > 4)
				goto L043a;
			...
			if (this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].DefenseStrength <= 2)
				goto L045d;
		...
		L043f:
			...
			if (this.oParent.GameData.Units[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].AttackStrength > 4)
				goto L043a;
			...
			if (this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].DefenseStrength > 2)
				goto L043a;
		...
		L045f:
			...
			this.oCPU.AX.UInt16 = 0x2b;
			goto L04ad;

		L0473:
			if (this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x24)) == 0)
				goto L0481;
		...
		L048f:
			if (this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)) != 0)
			{
				this.oCPU.AX.UInt16 = 40;
			}
			else
			{
				this.oCPU.AX.UInt16 = 38;
			}
			goto L04ad;
		...
		L049f:
			if (this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)) != 0)
			{
				this.oCPU.AX.UInt16 = 41;
			}
			else
			{
				this.oCPU.AX.UInt16 = 39;
			}

		L04ad:
			// Instruction address 0x29f3:0x04ae, size: 5
			this.oParent.CommonTools.PlayTune((short)this.oCPU.AX.UInt16, 0);
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26), 
				(short)this.oParent.GameData.Players[playerID1].Units[unitID1].NextUnitID);
		...
		L04ec:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.MapManagement.AdjustXPosition(this.oParent.GameData.Players[playerID1].Units[unitID1].Position.X - this.oParent.Var_d4cc_MapViewX);
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Players[playerID1].Units[unitID1].Position.Y);
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Players[playerID2].Units[unitID2].Position.X);
			this.oCPU.CX.UInt16 = (ushort)((short)this.oParent.GameData.Players[playerID1].Units[unitID1].Position.X);
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Players[playerID2].Units[unitID2].Position.Y);
			this.oCPU.CX.UInt16 = (ushort)((short)this.oParent.GameData.Players[playerID1].Units[unitID1].Position.Y);
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = (ushort)Math.Sign((short)this.oCPU.AX.UInt16);
			...
			if (this.oParent.GameData.Players[playerID1].Units[unitID1].Position.X == 79)
				goto L05d1;
		...
		L05a3:
			...
			if (this.oParent.GameData.Players[playerID2].Units[unitID2].Position.X != 79)
				goto L05d9;
		...
		L05de:
			...
			this.oParent.Graphics.F0_VGA_0c3e_DrawBitmapToScreen(this.oParent.Var_aa_Screen0_Rectangle,
				(short)this.oCPU.SI.UInt16 + 1, (short)this.oCPU.DI.UInt16 + 1,
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Screen1_Rectangle,
				(short)this.oCPU.SI.UInt16, (short)this.oCPU.DI.UInt16, 16, 16, this.oParent.Var_aa_Screen0_Rectangle, (short)this.oCPU.SI.UInt16, (short)this.oCPU.DI.UInt16);
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)), 0xa);
			...
			this.oParent.MapManagement.F0_2aea_11d4_DrawCellWithUnit(
				this.oParent.GameData.Players[playerID1].Units[unitID1].Position.X,
		...
		L06c1:
			...
			this.oParent.Graphics.F0_VGA_0c3e_DrawBitmapToScreen(this.oParent.Var_aa_Screen0_Rectangle,
				(short)this.oCPU.SI.UInt16 + 1, (short)this.oCPU.DI.UInt16 + 1,
				this.oParent.Array_d4ce[32 + this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c))]);
		...
		L076e:
			...
			if (!this.oParent.GameData.Players[playerID1].Diplomacy[playerID2].HasFlag(DiplomacyFlagsEnum.Unknown200))
				goto L07e2;
		...
		L0782:
			...
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Players[playerID1].Nationality);

			// Instruction address 0x29f3:0x07b5, size: 5
			this.oParent.CAPI.strcat(0xba06, " forces!\n");
		...
		L08c7:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), 0x19);
			...
			if (playerID2 == 0)
			{
				...
				if (this.oParent.GameData.Players[playerID2].Units[unitID2].UnitType == UnitTypeEnum.Diplomat)
				{
					...
					if (playerID1 == this.oParent.GameData.HumanPlayerID)
					{
						...
						this.oParent.CAPI.strcpy(0xba06, this.oParent.LanguageTools.F0_2f4d_044f_GetTextFromKingSection("*LEADER"));
		...
		L0987:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.UnitManagement.F0_1866_1251_GetStackUnitValueCoefficient(playerID2, unitID2, 2);
			...
			this.oParent.GameData.Players[playerID1].UnitsDestroyed[playerID2] += (short)this.oCPU.AX.UInt16;
		...
		L09db:
			...
			this.oParent.CAPI.strcat(0xba06, " units destroyed.\n");
		...
		L0a2d:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), 0x8);
		...
		L0a4c:
			...
			GPoint direction = this.oParent.MoveDirections[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))];
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa), (short)(this.oParent.GameData.Players[playerID2].Units[unitID2].Position.X + direction.X));

			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), (short)(this.oParent.GameData.Players[playerID2].Units[unitID2].Position.Y + direction.Y));

			// Instruction address 0x29f3:0x0a7f, size: 5
			this.oCPU.AX.Int16 = (short)this.oParent.MapManagement.F0_2aea_1458_GetCellActiveUnitID(
			...
			if (this.oParent.Var_d7f0 == this.oParent.GameData.HumanPlayerID) goto L0aaf;

			// Instruction address 0x29f3:0x0aa7, size: 5
			this.oParent.UnitManagement.F0_1866_1593_UnitStack(this.oParent.Var_d7f0,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a)));

		L0aaf:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.DEC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))));
			if (this.oCPU.Flags.NS) goto L0a4c;
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;

			if (this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].PlayerID == this.oParent.GameData.HumanPlayerID)
			{
				// Instruction address 0x29f3:0x0aca, size: 5
				this.oParent.AIEngine.F0_25fb_3e9c_MoveTransportNearEnemyCity(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)));
			}
		...
		L0b03:
			...
			this.oParent.GameData.Players[playerID1].Units[unitID1].Status |= 0x20;
		...
		L0b1b:
			...
			this.oParent.GameData.Players[playerID2].Units[unitID2].Status |= 0x20;
		...
		public void F0_29f3_0b66(short playerID, short unitID, short nextUnitID)
		{
			...
			if (this.oParent.GameData.Players[playerID].Units[nextUnitID].NextUnitID == -1)
			{
				...
				this.oParent.GameData.Players[playerID].Units[unitID].NextUnitID = nextUnitID;
			}
			else
			{
		...
		/// <param name="playerID"></param>
		/// <param name="unitID"></param>
		public void F0_29f3_0bc9(int playerID, int unitID)
		{
			this.oCPU.Log.EnterBlock($"F0_29f3_0bc9({playerID}, {unitID})");

			// function body
			short nextUnitID = (short)this.oParent.GameData.Players[playerID].Units[unitID].NextUnitID;
			...
			if (this.oParent.GameData.Players[playerID].Units[unitID].NextUnitID != -1)
			{
				...
				else
				{
					...
					do
					{
						...
						count++;
					} while (nextUnitID != -1 && count < 32 && this.oParent.GameData.Players[playerID].Units[nextUnitID].NextUnitID != unitID);

					if (count < 32 && nextUnitID != -1)
					{
						this.oParent.GameData.Players[playerID].Units[nextUnitID].NextUnitID =
							this.oParent.GameData.Players[playerID].Units[unitID].NextUnitID;
					}
				}
		...
		/// <param name="playerID"></param>
		/// <returns></returns>
		public ushort F0_29f3_0c9e(int playerID)
		{
			...
			this.oParent.CAPI.strcpy(0xba06, "We have signed a\npeace treaty with\nthe ");
		...
		L0d0a:
			if (this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].GovernmentType < 4) goto L0d43;
		...
		/// <param name="x"></param>
		/// <param name="y"></param>
		public void F0_29f3_0d4d(int playerID, int x, int y)
		{
			...
			this.oParent.CAPI.strcat(0xba06, " use\nnuclear weapons!\n");
		...
		L0d9b:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), 0x8);

		L0dae:
			GPoint direction = this.oParent.MoveDirections[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))];

			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), (short)(x + direction.X));

			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), (short)(y + direction.Y));
			...
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TEST_UInt16(this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].ImprovementFlags1, 0x1);
			if (this.oCPU.Flags.E) goto L0e4d;
		...
		L0e4d:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.UnitManagement.F0_1866_1251_GetStackUnitValueCoefficient(this.oParent.Var_d7f0,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)), 2);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), this.oCPU.AX.UInt16);
			
			this.oParent.GameData.Players[playerID].UnitsDestroyed[this.oParent.Var_d7f0] += (short)this.oCPU.AX.UInt16;

			// Instruction address 0x29f3:0x0e89, size: 5
			this.oParent.UnitManagement.F0_1866_0f10_DeleteUnitStack(this.oParent.Var_d7f0,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)));

			if (playerID == this.oParent.Var_d7f0) goto L0ea9;
			
			this.oParent.GameData.Players[this.oParent.Var_d7f0].Diplomacy[playerID] |= DiplomacyFlagsEnum.Vendetta | DiplomacyFlagsEnum.Unknown80;

		L0ea9:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), this.oCPU.DEC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))));
		...
		L0ed1:
			...
			this.oParent.CityWorker.F0_1d12_6d33_AddPollutionToCell(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)));
		...
		L0f13:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.MapManagement.AdjustXPosition(xPos + direction.X);
			...
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].ActualSize -= (sbyte)this.oCPU.AX.LowUInt8;
			goto L0f02;

...
namespace OpenCivOne
{
	public class GameReplay
	{
		...
		public GameReplay(OpenCivOneGame parent)
		{
			this.oParent = parent;
		...
		L0037:
			...
			this.oParent.CAPI.strcpy(0xba06, "File Error\n");
		...
		L01a1:
			...
			F9_0000_097c(this.oCPU.AX.UInt16);
		...
		L02a6:
			...
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x6810)].Nation);
			...
			this.oParent.CAPI.strcat(0xba06, " found the city of ");
		...
		L0300:
			...
			ushort usStringOffset = (ushort)(0xba06 + this.oParent.CAPI.strlen(0xba06));

			for (int i = 0; i < 0xd; i++)
			{
				this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(usStringOffset + i), (byte)this.oParent.GameData.CityNames[uiCityNameID][i]);
			}
		...
		L0336:
			...
			usStringOffset = (ushort)(0xba06 + this.oParent.CAPI.strlen(0xba06));
		...
		L03ae:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa))].Nation);

			// Instruction address 0x0000:0x03f0, size: 5
			this.oParent.CAPI.strcat(0xba06, " declare war on ");

		L03eb:
			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Nation);
		...
		L0414:
			...
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa))].Nation);

			// Instruction address 0x0000:0x03f0, size: 5
			this.oParent.CAPI.strcat(0xba06, " make peace with ");
		...
		L0453:
			...
			this.oParent.CAPI.strcat(0xba06, " discover ");
		...
		L04a8:
			...
			this.oParent.CAPI.strcat(0xba06, " produce first ");

			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name);
		...
		L054f:
			...
			this.oParent.CAPI.strcat(0xba06, " build ");

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x7);
		...
		L05ad:
			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.GameData.Wonders[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name);
		...
		L05b9:
			...
			this.oParent.CAPI.strcat(0xba06, " cities; ");

			// Instruction address 0x0000:0x064e, size: 5
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameTools.F0_2dc4_0337_PopulationValueToString(
			...
			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.CAPI.strcat(0xba06, " population");
		...
		L0671:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.GameData.Players[this.oParent.GameData.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))] >> 4].Nation);
		...
		L06e8:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.GameData.Players[this.oParent.GameData.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))] & 0xf].Nation);
		...
		L0779:
			...
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x6810)].Nationality);

			// Instruction address 0x0000:0x07b9, size: 5
			this.oParent.CAPI.strcat(0xba06, " civilization destroyed by ");
				...
				if (param1 > 50)
				{
					...
					if (param1 > 50)
					{
						...
						if (param1 > 50)
						{
							...
							this.oCPU.AX.UInt16 = (ushort)(param1 + 1850);
						}
						else
						{
							this.oCPU.AX.UInt16 = (ushort)((param1 << 1) + 1750);
						}
					}
					else
					{
						this.oCPU.AX.UInt16 = (ushort)((param1 * 5) + 1500);
					}
				}
				else
				{
					this.oCPU.AX.UInt16 = (ushort)((param1 * 10) + 1000);
				}
			}
			else
			{
				this.oCPU.AX.UInt16 = (ushort)((param1 * 20) - 4000);
			}
		...
		L0ada:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.GameTools.F0_2dc4_007c_CheckValueRange(xPos - 5, 0, 80);
			...
			this.oCPU.AX.Int16 = (short)this.oParent.GameTools.F0_2dc4_007c_CheckValueRange(yPos - 5, 2, 49);
		...
		public void F9_0000_0dde()
		{
			...
			this.oParent.GameTools.F0_2dc4_065f_StopPaletteCycleSlots();
		...
		L135f:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(Math.Abs((short)param2), 10));
			...
			this.oParent.GameTools.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), "");

...
namespace OpenCivOne
{
	public class Overlay_20
	{
		...
		L05ed:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.GameData.GetImprovementType(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)) + 1).Name);
		...
		L0835:
			...
			this.oParent.Array_30b8[0] = this.oParent.GameData.GetImprovementType(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)) + 1).Name;
		...
		L0995:
			...
			if (this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID, TechnologyAdvanceEnum.Religion) &&
				(this.oParent.GameData.Cities[cityID].ImprovementFlags0 & 0x400) == 0)
			{
				// Instruction address 0x0000:0x09c8, size: 5
		...
		L0cd9:
			...
			this.oParent.DrawTools.F0_1182_00b3_DrawCenteredStringToScreen0("SCORING COMPLETED", 160, 100, 15);
		...
		L0e79:
			...
			this.oParent.CAPI.strcat(0xba06, " Citizens (");
		...
		L0fd6:
			...
			this.oParent.CAPI.strcat(0xba06, " Achievements (");
		...
		L1088:
			...
			this.oParent.CAPI.strcpy(0xba06, "SpaceShip: (");
		...
		L10d0:
			...
			this.oParent.CAPI.strcat(0xba06, " possible");
		...
		L1118:
			...
			this.oParent.CAPI.strcpy(0xba06, "Pollution: (");
		...
		L1174:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.GameTools.F0_2dc4_007c_CheckValueRange(this.oParent.GameData.PeaceTurnCount * 3, 0, 100);
			...
			this.oParent.CAPI.strcat(0xba06, "Peace: (+");
		...
		L11e3:
			...
			this.oParent.CAPI.strcat(0xba06, "Future Tech: (+");
		...
		L128e:
			...
			this.oParent.CAPI.strcpy(0xba06, "Total Score: ");
		...
		L12d6:
			...
			this.oParent.CAPI.strcpy(0xba06, "Bonus Score: ");
		...
		L1348:
			...
			if (this.oParent.GameData.Players[0].Score > 0)
			{
				...
				this.oCPU.AX.Int16 = (short)this.oParent.GameTools.F0_2dc4_007c_CheckValueRange(this.oParent.GameData.Players[0].Score / 4, 0, 250);

...
namespace OpenCivOne.Compression
{
	/// <summary>
	/// Implementation of dictionary item used by Lempel–Ziv–Welch compression algorithm as implemented in original Civilization game
	/// </summary>
